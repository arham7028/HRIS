...
<div class="container clearfix">
  ...
  <script>
	...
	let otp_val = "User mail "+email.value+"<br>User Name"+name.value+"<br>Contact: "+contact.value+"<br>Query: "+msg.value;

	let emailbody = `<h2>Query From User: </h2>${otp_val}`;
	Email.send({
    SecureToken : "5ea87299-13d2-49eb-94e0-5afd21cec296",
    To : "syedarham.sa81@gmail.com",
	...
	message => {
		if (message === "OK") {
			alert("Thanks for your feedback!!! We will further update you at your email " + email.value);
