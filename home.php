						...
						<div class="swiper-slide dark">
							<div class="container clearfix">
								<div class="slider-caption slider-caption-center">
									<h2 data-caption-animate="fadeInUp">Let get upgrade together</h2>
									<p data-caption-animate="fadeInUp" data-caption-delay="200"></p>
								</div>
							</div>
							<div class="video-wrap">
								<img src="images/slider/slide6.jpg" style="height: 1920; width : 1280">
								<div class="video-overlay" style="background-color: rgba(0,0,0,0.55);"></div>
							</div>
						</div>
						<div class="swiper-slide dark" style="background-image: url('images/slider/slide4.jpg'); background-position: center top;">
							<div class="container clearfix">
								<div class="slider-caption">
									<h2 data-caption-animate="fadeInUp">We are exceptional</h2>
									<p data-caption-animate="fadeInUp" data-caption-delay="200">We are here to achieve your expectations.</p>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row clearfix">
						...
						<div class="col-lg-5">
							<div class="heading-block topmargin">
								<h1>Welcome to Our <br>Family</h1>
							</div>
							<p class="lead">We are a group of hardworkers; our aim is to promote education and skills. If you are a domestic worker, then connect with us to secure your future and upgrade your skills. We deliver free international standard video lectures and content. We are also providing services in Rural Areas &amp; Metro Cities.</p>
						</div>

						<div class="col-lg-7">

							<div style="position: relative; margin-bottom: -60px;" class="ohidden" data-height-lg="426" data-height-md="567" data-height-sm="470" data-height-xs="287" data-height-xxs="183">
								<img src="images/services/work.jpg" style="position: absolute; top: 0; left: 0; margin-top: 10%" data-animate="fadeInUp" data-delay="100" alt="Chrome" data-height-lg="426" data-height-md="567" data-height-sm="470" data-height-xs="287" data-height-xxs="183">
					...
					<div class="container clear-bottommargin clearfix">
						...
						<div class="row topmargin-sm clearfix">
							...
							<div class="col-md-4 bottommargin">
								...
								<p>We are here for achieve your expectations. Our professional instructors have care about your skills. They are positive, willing to go the distance to get the job done and bring their best every day.</p>
							</div>
				...
				<div class="container clearfix" id="features">
					...
					<div class="row topmargin-lg bottommargin-sm">
						...
						<div class="heading-block center">
							...
							<span class="divcenter">Our team and instructors have many unique qualities &amp; skills. Dear workers, We are providing free online learning platform. Where your skills are polished.</span>
						</div>
						...
						<div class="col-md-4 hidden-sm bottommargin center">
							<img src="images/services/mobil2.png" alt="iphone 2">
						</div>
						...
						<div class="col-md-4 col-sm-6 bottommargin">
							...
							<div class="feature-box topmargin" data-animate="fadeIn">
								...
								<p>We are also providing international standard lectures at this platform.</p>
							</div>
				...
				<div class="row clearfix bottommargin-lg common-height">
					...
					<div class="col-md-4 col-sm-6 dark center col-padding" style="background-color: #576F9E;">
						<div>
							...
							//  }
							?>
							<div class="counter counter-lined"><span data-from="2" data-to="4" data-refresh-interval="100" data-speed="2500"></span></div>
							<h5>Team Members</h5>
						</div>
					</div>
					...
					<div class="col-md-4 col-sm-6 dark center col-padding" style="background-color: #6697B9;">
						<div>
							...
							?>
							<div class="counter counter-lined"><span data-from="1" data-to="<?php echo $sno; ?>" data-refresh-interval="25" data-speed="4000"></span></div>
					...
					<div class="col-md-4 col-sm-6 dark center col-padding" style="background-color: #88C3D8;">
						<div>
							...
							?>
							<div class="counter counter-lined"><span data-from="1" data-to="<?php echo $sno; ?>" data-refresh-interval="30" data-speed="3500"></span></div>
							<h5>No. of Courses</h5>
						</div>
					</div>
