        ...
        <div class="mask d-flex align-items-center h-100 gradient-custom-3">
              ...
              <div class="col-12 col-md-9 col-lg-7 col-xl-6 mt-3">
                <div class="card bg-dark m-2" style="border-radius: 15px">
                  <div class="card-body p-5">
                    ...
                    <form method="POST" style="margin-bottom: 0;" action="./PDO/ppost.php" onsubmit="validate_post()">
          ...
          <ul class="list-unstyled list-inline text-center py-0">
            <li class="list-inline-item">
              <h3 class="mt-0 mb-3 text-light">Register for free</h3>
            </li>
            <br />
            <li class="list-inline-item">
              <a href="fregister.html" class="btn btn-outline-light"><h4>Sign up!</h4></a>
            </li>
          </ul>
          <!-- Call to action -->
        </div>
