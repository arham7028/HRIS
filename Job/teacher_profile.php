        ...
        <div class="container clearfix ">
            ...
            ?>
                <section class="playlist-videos">
                    ...
                    <div class="profile">
                        <img src="../gotoep/images/instructor/<?php echo $profile["image"];?>" alt="Worker Photo">
                        <h1><?php echo $profile["name"];?></h1>
                        <div class="info">
                            <p><strong>Qualification:</strong> <?php echo $profile["qualification"];?></p>
                            <p><strong>Email:</strong> <?php echo $profile["mail"];?></p>
                            <p><strong>Phone Number:</strong> <?php echo $profile["phone"];?></p>
                            <p><strong>Total Courses:</strong> <?php echo $count; ?></p>
                            <p><strong>Bio:</strong> <?php echo $profile["description"];?></p>
                        </div>
                    </div>
                    <!-- <div class="feedback"> -->
                        <!-- <h2>Feedback:</h2> -->
