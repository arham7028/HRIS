...
<header class="header">
   ...
   <img src="Images/logo8.png" alt="" style="height: 50px; margin-left: -53px;">
        ...
        <div class="container">
            <nav>
                <ul>
                    ...
                    <li  class="current"><a href="blog.php"><i class="icon-line-content-left"></i>Back</a> </li>
...
<h1 class="heading"><?php echo $row2['title']; ?></h1>
...
<div class="m-auto blog-post-content max-width-2 m-auto my-2">
        <div class="blogpost-meta">
            <div class="author-info">
                <div>
                <b>
                  <h2>Author - <?php echo $row['name'] ;?></h2>
                </b>
                </div>
                <div><?php echo $row2['postDate'] ;?> </div>
            </div>
        ...
        <br>
           ...
           <iframe src="https://www.youtube.com/embed/Ut2jlLOGKkg?si=TFDE-fsWQs8uVUhLhttps://www.youtube.com/embed/Ut2jlLOGKkg?si=TFDE-fsWQs8uVUhL" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen="" style="padding: 12px; height: 55%; width: 100%;"></iframe>
        <br>
