    ...
    max-width: 1392px;
       ...
       <div class="container">
           ...
           <div class="row center">
             ...
             <!-- width: 264px; -->
                <select name="filter" id="selectid" class="form-select border-0 py-2 col-md-3 height: 44px;" style="font-size: 1.5rem; font-family: 'Raleway', sans-serif;">
                ...
                <button class="btn btn-success border-0 py-3 col-md-2" style="margin-left: 32px;margin-top: 6px;">Search
            </button>
                         </div>
            </div>
           </form>
