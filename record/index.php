...
<html class="no-js" lang="">
    <head>
        ...
        <title>HRIS Employee Record</title>
 ...
 <body id="loginPage">
 	<div class="login_wrapper clearfix">
 		<div class="logo_login">
 			<img src="images/l10.png" alt="Sharpnet Logo">
 		</div>
        <?php
            if(isset($_GET['error'])){
        ...
        <div class="LogResponse"></div>
 		<div class="login_wrapper_inner">
 			<form id="loginForm" class="clearfix" method="post" action="index.php">
	 			<div class="input-box">
