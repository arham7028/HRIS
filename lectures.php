...
<header class="header">
   ...
   <section class="flex">
      ...
      <!-- <form action="lectures.php" method="post" class="search-form">
         <input type="text" name="search_box" required placeholder="Search Lecture" maxlength="100">
...
<!--  clearfix -->
            <nav>
                <ul>
                    ...
                    <li  class="current"><a href="index.php?page=course"><i class="icon-line-content-left"></i>Back</a> </li>
